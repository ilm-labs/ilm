...
RSpec.describe 'Ilm::Chemical::Reactors::Reactor#new' do
  it 'should_initialize_with_correct_volume' do
  ...
  it 'should_initialize_with_correct_system' do
  ...
  it 'should_initialize_with_correct_reaction' do
...
#   it 'should_initialize_with_correct_input' do
#     r = Ilm::Chemical::Reactors::Reactor.new
#     r.volume = 10.l
#     expect(r.volume).to eq 10.l
#   end
...
# it 'should_initialize_with_correct_reaction_and_input' do
#   expect do
